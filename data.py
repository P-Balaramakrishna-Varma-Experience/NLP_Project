...
def build_vocabularies(data_file):
    ...
    vocab_deptyp = torchtext.vocab.build_vocab_from_iterator(dep_typ, specials=["<pad>"], special_first=True)
    ...
    vocab_words = torchtext.vocab.build_vocab_from_iterator(words, min_freq=2, specials=["<pad>"], special_first=True)
